			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						...
						<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="/admin/selectStudent?page=1&pageSize=5" id="form1" method="post">
				...
				<div class="panel-footer">
					<nav style="text-align: center">
						<ul class="pagination">
							<li>
								<a aria-label="Previous" href="${pageContext.request.contextPath}/admin/showStudent?page=1&pageSize=${pageInfo.pageSize}">首页</a>
							</li>
							<li><a href="${pageContext.request.contextPath}/admin/showStudent?page=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a></li>

							<c:forEach begin="1" end="${pageInfo.pages}" var="i">
								<c:if test="${i==pageInfo.pageNum}">
									<li><a style="background-color: #2aabd2" href="${pageContext.request.contextPath}/admin/showStudent?page=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
								</c:if>
								<c:if test="${i!=pageInfo.pageNum}">
									<li><a href="${pageContext.request.contextPath}/admin/showStudent?page=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
								</c:if>
							</c:forEach>

							<li><a href="${pageContext.request.contextPath}/admin/showStudent?page=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a></li>
							<li>
								<a href="${pageContext.request.contextPath}/admin/showStudent?page=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a>
							</li>
						</ul>
					</nav>
				</div>
